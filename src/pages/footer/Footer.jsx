...
export const Footer = () => {
    ...
    return (
        <Box h={'300px'} bg={'black'} color={'white'} mt={'40px'}>
            ...
            <Center h={'80px'}>
                <Text className="typeWritertheme">Made with <Icon as={FcLike} /> by khushi Gupta</Text>
            </Center>
            ...
            >
                ...
                >
                    <IconLink
                        ...
                        link={"https://khushiguptaportfolio.netlify.app/"}
                    />
                    <IconLink
                        icon={FaGithub}
                        link={"https://github.com/khushi89012"}
                    />
                    <IconLink
                        icon={FaLinkedin}
                        link={"https://www.linkedin.com/in/khushi-gupta-279650229/"}
                    />
                </Flex>
